...
export const meta = {
  ...
  description: "Discover how to make your terminal presentable.",
  date: "2021-04-12T19:45:00.0Z",
  url: "terminal",
  image: "terminal-setup.png",
  authors: [raphael],
};

export default ({ children }) => <Layout meta={meta}>{children}</Layout>;

![terminal-setup](/blog/terminal-setup.png)
