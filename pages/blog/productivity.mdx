...
Ideally, you already know all of this and can skip straight to the [next section]().
...
## Learning More With [Cheet Sheet]()

Technichally, you can look up all the short cuts by scrolling through the menu bar of each app.
To help you discover new short cuts in a more user friendly way, download [cheet sheet]().
...
will immediately launch file search. Next, I would enable key bindings for the window management extension. This way Raycast will be able to do what [Rectangle]() does
without any additional installations. Lastly, I would recommend installing my [Google Maps Search]() extension. This will let you pull up directions from your current location
